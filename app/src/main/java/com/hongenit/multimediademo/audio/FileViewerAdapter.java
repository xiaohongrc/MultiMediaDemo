...
//    private DBHelper mDatabase;
    ...
    private ArrayList<RecordingItem> mRecordings = new ArrayList<>();
    ...
    public void refreshData() {
        ...
        if (Constans.APP_AUDIO_FOLDER.exists()) {
            ...
            for (File file : files) {
                ...
                recordingItem.setLength((int) file.length());
                mRecordings.add(recordingItem);
            }
        }
